            ...
            <div class="col-md-7 col-sm-12 col-xs-12 vcenter vcenter-left">
                <div class="form-line-text">
                    <div class="form-line-div">
                        <img src="<? bloginfo("template_directory");?>/images/email-white.png" alt=""><strong>Купить бытовку</strong>
                    </div>                          
...
<!--                     <? if($formText) { 
            ...
            <div class="col-md-5 col-sm-12 col-xs-12 vcenter vcenter-right">
                <div class="form-line-form">
                    <div class="row">
                        <h3>Онлайн-заявка</h3>
                        <? echo do_shortcode('[contact-form-7 id="3066" title="Онлайн-заявка_купить"]'); ?>
                    </div>
                </div>
            </div>
        </div>
