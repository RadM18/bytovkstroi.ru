<?php
/* template name: Услуга внутренняя подкаталог*/
        ...
        <div class="container">
            <div class="row">
               ...
               <div class="box-div-order">
                ...
                <div class="btn-wrap-buy"><button class="btn btn-buy" onclick="tModalForm.show('buy');">Заказать бытовку</button></div>
            </div>
        </div>
    </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-8 col-md-offset-2">
                    <h2 class='center center-line'>Стоимость аренды бытовки</h2>
                    <? the_field('seo_text'); ?>
                </div>
            </div>
        </div>
