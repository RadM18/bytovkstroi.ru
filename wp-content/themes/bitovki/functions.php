...
function twentyseventeen_setup() {
	...
	register_nav_menus( array(
		...
		'top2'    => __( 'Top Menu2', 'twentyseventeen' ),
...
function kama_excerpt( $args = '' ){
	...
	$default = array(
		'maxchar'   => 160,   // количество символов.
...
<a href="%s" itemprop="item"><span itemprop="name">Главная</span></a> 
</span> ', 
...
if( count($crumbsArr) < $minCount ) return false; 
...
function true_load_posts(){
	...
	if( have_posts() ) :
		...
		while( have_posts() ): the_post();
			...
			get_template_part( 'template-parts/post/content-feed', get_post_format() );
...
add_action('wp_ajax_modal_content', 'data_fetch');
add_action('wp_ajax_nopriv_modal_content', 'data_fetch');
