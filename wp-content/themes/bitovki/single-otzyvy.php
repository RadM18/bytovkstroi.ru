...
<?php
/*
Template Name: Отзыв текстовый с фото
...
<div class="feedback-text-photo">
    ...
    <div class="feedback-photo">
                    ...
                    <div class="col-md-8 col-sm-8 col-xs-12">
                     ...
                     <div class="col-md-4 col-sm-4 col-xs-12">
                        <div class="feedback-thumb">
                            <img src="<? echo kama_thumb_src('src=' . wp_get_attachment_url(get_post_thumbnail_id( $post->ID )) . '&w=400&h=400'); ?>">
                        </div>
                    </div>
        ...
        <div class="news-block">
            ...
            <div class="container">
                <div class="row">
                    <h2 class="left">Новости и статьи</h2>
                    <? $args = array(
                        'category' => 8,
                        'posts_per_page' => 4,
